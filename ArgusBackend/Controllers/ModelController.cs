...
namespace ArgusBackend.Controllers
{
    ...
    public class ModelController : ControllerBase
    {
        ...
        public async Task<ActionResult<Model>> Create(Model model)
        {
            ...
            try
            {
                response = await _httpClient.PostAsync("http://tcsystem-api:8003/submit", content);
                ...
                var logResponseMessage = await _httpClient.PostAsync("http://backend-api:8080/api/Log", logContent);
